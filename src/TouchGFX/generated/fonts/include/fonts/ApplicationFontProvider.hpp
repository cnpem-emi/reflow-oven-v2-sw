...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId STATUS = 3;        // arialbd_14_4bpp
    static const touchgfx::FontId VALORES = 4;       // ariblk_20_4bpp
    static const touchgfx::FontId TELA_INICIAL = 5;  // arial_20_4bpp
    static const touchgfx::FontId BOTAO_INICIAR = 6; // arialbd_15_4bpp
    static const touchgfx::FontId INFORMACOES = 5;   // arial_20_4bpp
